# Makefile for db-zpark-pyf project
...
help:
	@echo "db-zpark-pyf Project Makefile"
	@echo "------------------------"
...
test-cov:
	...
	@poetry run pytest --cov=src/db_zpark_pyf tests/
	@echo "Coverage tests complete!"

lint:
	@echo "Running linters..."
	@poetry run flake8 src/db_zpark_pyf tests
	@poetry run mypy src/db_zpark_pyf
	@echo "Linting complete!"

format:
	@echo "Formatting code..."
	@poetry run black src/db_zpark_pyf tests
	@poetry run isort src/db_zpark_pyf tests
